    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if(!_roleManager.RoleExistsAsync(Role.Admin).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(Role.Company)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(Role.Employee)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(Role.Individual)).GetAwaiter().GetResult();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(Input.Role == null)
                    {
                        await _userManager.AddToRoleAsync(user, Role.Individual);
                    }
                    else
                    {
